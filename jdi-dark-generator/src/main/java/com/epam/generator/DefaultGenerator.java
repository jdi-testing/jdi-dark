...
public class DefaultGenerator {
    protected static final Logger LOGGER = LoggerFactory.getLogger(DefaultGenerator.class);
    ...
    public void processOpts() {
        if (additionalProperties.containsKey(GeneratorConstants.TEMPLATE_DIR)) {
            this.setTemplateDir((String) additionalProperties.get(GeneratorConstants.TEMPLATE_DIR));
        }

        if (additionalProperties.containsKey(GeneratorConstants.MODEL_PACKAGE)) {
            this.setModelPackage((String) additionalProperties.get(GeneratorConstants.MODEL_PACKAGE));
        }

        if (additionalProperties.containsKey(GeneratorConstants.API_PACKAGE)) {
            this.setApiPackage((String) additionalProperties.get(GeneratorConstants.API_PACKAGE));
        }

        if(additionalProperties.containsKey(GeneratorConstants.MODEL_NAME_PREFIX)){
            this.setModelNamePrefix((String) additionalProperties.get(GeneratorConstants.MODEL_NAME_PREFIX));
        }

        if(additionalProperties.containsKey(GeneratorConstants.MODEL_NAME_SUFFIX)){
            this.setModelNameSuffix((String) additionalProperties.get(GeneratorConstants.MODEL_NAME_SUFFIX));
        }

        if (additionalProperties.get(GeneratorConstants.IGNORE_IMPORT_MAPPING_OPTION) != null) {
            setIgnoreImportMapping(Boolean.parseBoolean( additionalProperties.get(GeneratorConstants.IGNORE_IMPORT_MAPPING_OPTION).toString()));
        } else {
    ...
    public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
        if (supportsInheritance) {
            ...
            Map<String, GeneratedModel> allModels = new HashMap<String, GeneratedModel>();
            ...
            for (GeneratedModel cm : allModels.values()) {
                if (cm.parent != null) {
                    cm.parentModel = allModels.get(cm.parent);
                }
                if (cm.interfaces != null && !cm.interfaces.isEmpty()) {
                    cm.interfaceModels = new ArrayList<GeneratedModel>(cm.interfaces.size());
                    for (String intf : cm.interfaces) {
                        GeneratedModel intfModel = allModels.get(intf);
                        if (intfModel != null) {
            ...
            for (String name : allModels.keySet()) {
                GeneratedModel cm = allModels.get(name);
                GeneratedModel parent = allModels.get(cm.parent);
                // if a discriminator exists on the parent, don't add this child to the inheritance hierarchy
                // TODO Determine what to do if the parent discriminator name == the grandparent discriminator name
                while (parent != null) {
                    if (parent.children == null) {
                        parent.children = new ArrayList<GeneratedModel>();
                    }
    ...
    public Map<String, Object> postProcessModelsEnum(Map<String, Object> objs) {
        ...
        for (Object _mo : models) {
            ...
            for (GeneratedProperty var : cm.vars) {
                updateCodegenPropertyEnum(var);
            }
            if (cm.vars != cm.allVars) {
                for (GeneratedProperty var : cm.allVars) {
                    updateCodegenPropertyEnum(var);
                }
            }
        }
    ...
    public String apiPackage() { return apiPackage; }
    ...
    public String apiFileFolder() { return outputFolder + "/" + apiPackage().replace('.', '/'); }
    ...
    public DefaultGenerator() {
        ...
        cliOptions.add(CliOption.newBoolean(GeneratorConstants.SORT_PARAMS_BY_REQUIRED_FLAG,
                GeneratorConstants.SORT_PARAMS_BY_REQUIRED_FLAG_DESC).defaultValue(Boolean.TRUE.toString()));
        cliOptions.add(CliOption.newBoolean(GeneratorConstants.ENSURE_UNIQUE_PARAMS, GeneratorConstants
                .ENSURE_UNIQUE_PARAMS_DESC).defaultValue(Boolean.TRUE.toString()));

        // name formatting options
        cliOptions.add(CliOption.newBoolean(GeneratorConstants.ALLOW_UNICODE_IDENTIFIERS, GeneratorConstants
     ...
     */
    public GeneratedModel fromModel(String name, Model model) {
    ...
    public GeneratedModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        GeneratedModel m = ModelFactory.newInstance(ModelType.MODEL);
        if (reservedWords.contains(name)) {
        ...
        if (model instanceof ArrayModel) {
            ...
            if (supportsInheritance || supportsMixins) {
                ...
                m.allVars = new ArrayList<GeneratedProperty>();
        ...
        if (m.vars != null) {
            for(GeneratedProperty prop : m.vars) {
    ...
    protected void addAdditionPropertiesToCodeGenModel(GeneratedModel codegenModel, ModelImpl swaggerModel) {
     ...
     */
    public GeneratedProperty fromProperty(String name, Property p) {
        if (p == null) {
            LOGGER.error("unexpected missing property for name " + name);
            return null;
        }

        GeneratedProperty property = ModelFactory.newInstance(ModelType.PROPERTY);
        ...
        if (p instanceof ArrayProperty) {
            ...
            GeneratedProperty cp = fromProperty(itemName, ap.getItems());
            ...
            // handle inner property
            GeneratedProperty cp = fromProperty("inner", ap.getAdditionalProperties());
     ...
     */
    protected void updatePropertyForArray(GeneratedProperty property, GeneratedProperty innerProperty) {
     ...
     * @param innerProperty Codegen inner property of map or list
     */
    protected void updatePropertyForMap(GeneratedProperty property, GeneratedProperty innerProperty) {
        if (innerProperty == null) {
     ...
     */
    protected Boolean isPropertyInnerMostEnum(GeneratedProperty property) {
        GeneratedProperty currentProperty = property;
    ...
    protected Map<String, Object> getInnerEnumAllowableValues(GeneratedProperty property) {
        GeneratedProperty currentProperty = property;
        while (currentProperty != null && (Boolean.TRUE.equals(currentProperty.isMapContainer)
                || Boolean.TRUE.equals(currentProperty.isListContainer))) {
            currentProperty = currentProperty.items;
     ...
     * @param property Codegen property
     */
    protected void updateDataTypeWithEnumForArray(GeneratedProperty property) {
        GeneratedProperty baseItem = property.items;
     ...
     * @param property Codegen property
     */
    protected void updateDataTypeWithEnumForMap(GeneratedProperty property) {
        GeneratedProperty baseItem = property.items;
        while (baseItem != null && (Boolean.TRUE.equals(baseItem.isMapContainer)
                || Boolean.TRUE.equals(baseItem.isListContainer))) {
            baseItem = baseItem.items;
    ...
    protected void setNonArrayMapProperty(GeneratedProperty property, String type) {
     ...
     */
    public GeneratedOperation fromOperation(String path, String httpMethod, Operation operation, Map<String, Model> definitions) {
     ...
     * @return Codegen Operation object
     */
    public GeneratedOperation fromOperation(String path,
                                            String httpMethod,
                                            Operation operation,
                                            Map<String, Model> definitions,
                                            Swagger swagger) {
        GeneratedOperation op = ModelFactory.newInstance(ModelType.OPERATION);
        ...
        if (operation.getResponses() != null && !operation.getResponses().isEmpty()) {
            ...
            for (Map.Entry<String, Response> entry : operation.getResponses().entrySet()) {
                ...
                GeneratedResponse r = fromResponse(entry.getKey(), response);
                r.hasMore = true;
                if (r.baseType != null &&
            ...
            if (methodResponse != null) {
                ...
                if (responseProperty != null) {
                    ...
                    GeneratedProperty cm = fromProperty("response", responseProperty);

                    if (responseProperty instanceof ArrayProperty) {
                        ArrayProperty ap = (ArrayProperty) responseProperty;
                        GeneratedProperty innerProperty = fromProperty("response", ap.getItems());
                        op.returnBaseType = innerProperty.baseType;
                    } else if (responseProperty instanceof MapProperty) {
                        MapProperty ap = (MapProperty) responseProperty;
                        GeneratedProperty innerProperty = fromProperty("response", ap.getAdditionalProperties());
                        op.returnBaseType = innerProperty.baseType;
                    } else {
                    ...
                    if (definitions != null) {
                        ...
                        if (m != null) {
                            GeneratedModel cmod = fromModel(op.returnBaseType, m, definitions);
        ...
        GeneratedParameter bodyParam = null;
        List<GeneratedParameter> allParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> bodyParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> pathParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> queryParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> headerParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> cookieParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> formParams = new ArrayList<GeneratedParameter>();
        List<GeneratedParameter> requiredParams = new ArrayList<GeneratedParameter>();

        if (parameters != null) {
            for (Parameter param : parameters) {
                GeneratedParameter p = fromParameter(param, imports);
                // rename parameters to make sure all of them have unique names
                if (ensureUniqueParams) {
                    while (true) {
                        boolean exists = false;
                        for (GeneratedParameter cp : allParams) {
        ...
        if (sortParamsByRequiredFlag) {
            Collections.sort(allParams, new Comparator<GeneratedParameter>() {
                @Override
                public int compare(GeneratedParameter one, GeneratedParameter another) {
     ...
     */
    public GeneratedResponse fromResponse(String responseCode, Response response) {
        GeneratedResponse r = ModelFactory.newInstance(ModelType.RESPONSE);
     ...
     */
    public GeneratedParameter fromParameter(Parameter param, Set<String> imports) {
        GeneratedParameter p = ModelFactory.newInstance(ModelType.PARAMETER);
        ...
        if (param instanceof SerializableParameter) {
            ...
            if ("array".equals(type)) { // for array parameter
                ...
                GeneratedProperty pr = fromProperty("inner", inner);
                p.items = pr;
            ...
            GeneratedProperty cp = fromProperty(qp.getName(), property);
            ...
            if (model instanceof ModelImpl) {
                ModelImpl impl = (ModelImpl) model;
                GeneratedModel cm = fromModel(bp.getName(), impl);
                if (!cm.emptyVars) {
                    ...
                    GeneratedProperty cp = fromProperty("property", prop);
                    if (cp != null) {
                ...
                GeneratedProperty cp = fromProperty("inner", ap);
                if (cp.complexType != null) {
                    imports.add(cp.complexType);
                }
    ...
    private void addHeaders(Response response, List<GeneratedProperty> target) {
    ...
    private static List<GeneratedParameter> addHasMore(List<GeneratedParameter> objs) {
        if (objs != null) {
     ...
     */
    @SuppressWarnings("static-method")
    public void addOperationToGroup(String tag, String resourcePath, Operation operation, GeneratedOperation co, Map<String, List<GeneratedOperation>> operations) {
        List<GeneratedOperation> opList = operations.get(tag);
        if (opList == null) {
            opList = new ArrayList<GeneratedOperation>();
        ...
        int counter = 0;
        for(GeneratedOperation op : opList) {
    ...
    private void addParentContainer(GeneratedModel m, String name, Property property) {
        final GeneratedProperty tmp = fromProperty(name, property);
    ...
    protected void addImport(GeneratedModel m, String type) {
        if (type != null && needToImport(type)) {
            m.imports.add(type);
        }
    }

    private void addVars(GeneratedModel m, Map<String, Property> properties, List<String> required, Map<String, Model> allDefinitions) {
    ...
    private void addVars(GeneratedModel m, List<GeneratedProperty> vars, Map<String, Property> properties, Set<String> mandatory, Map<String, Model> allDefinitions) {
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            if (prop == null) {
                ...
                final GeneratedProperty cp = fromProperty(key, prop);
     ...
     * @param property  Codegen property
     */
    public void setParameterBooleanFlagWithCodegenProperty(GeneratedParameter parameter, GeneratedProperty property) {
        if (parameter == null) {
     ...
     */
    public void updateCodegenPropertyEnum(GeneratedProperty var) {
