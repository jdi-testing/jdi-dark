...
public class GeneratedProperty implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        final GeneratedProperty other = (GeneratedProperty) obj;
    ...
    @Override
    public GeneratedProperty clone() {
        try {
            GeneratedProperty cp = (GeneratedProperty) super.clone();
            if (this._enum != null) {
