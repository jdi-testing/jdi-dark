...
public class GetBookTests extends BaseTestClass {
    ...
    private void initBooks() {
        book1 = new Book().set(b -> {
            b.isbn = "9780679735779";
            b.title = "American Psycho";
            b.author = "Bret Easton Ellis";
            b.publicationYear = "1991";
            b.price = "9.89";
            b.quantity = 2;
            b.genres = asList(
                new Genre().set(g -> g.type = "Black comedy"),
                new Genre().set(g -> g.type = "Postmodernism"),
                new Genre().set(g -> g.type = "Horror")
            );
        });

        book2 = new Book().set(b -> {
            b.isbn = "9780393341768";
            b.title = "A Clockwork Orange";
            b.author = "Anthony Burgess";
