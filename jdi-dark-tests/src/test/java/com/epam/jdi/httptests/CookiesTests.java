...
public class CookiesTests {
    ...
    public void supportsCookieStringMatchingViaDsl() {
        JettyService.setCookies.call().assertThat().cookie("key1", "value1");
    }


    @Test
    public void supportsMultipleCookieStatements() {
        JettyService.setCookies.call().assertThat().cookie("key1", "value1").and().cookie("key2", "value2");
    }

    @Test
    public void supportsMultipleCookiesShortVersionUsingPlainStrings() {
        JettyService.setCookies.call().assertThat().cookies("key1", "value1", "key3", "value3");
    }

    @Test
    public void supportsMultipleCookiesShortVersionUsingHamcrestMatching() {
        JettyService.setCookies.call().assertThat().cookies("key2", containsString("2"), "key3", equalTo("value3"));
    }
