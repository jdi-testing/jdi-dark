...
public class NumberConversionServiceTest {
    ...
    public void checkNumberToDollars() {
        NumberToDollarsResponse response = getNumberConversionService().numberToDollars.callSoap(new NumberToDollars()
    ...
    public void checkNumberToWords() {
        NumberToWordsResponse response = getNumberConversionService().numberToWords.callSoap(new NumberToWords()
    ...
    public void checkNumberToDollars12() {
        NumberToDollarsResponse response = getNumberConversionService().numberToDollars12.callSoap(new NumberToDollars()
    ...
    public void checkNumberToWords12() {
        NumberToWordsResponse response = getNumberConversionService().numberToWords12.callSoap(new NumberToWords()
    ...
    public NumberConversionService getNumberConversionService() {
        return init(NumberConversionService.class);
    }
}
